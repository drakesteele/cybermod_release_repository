...
questMod.EntityManager[tag]=nil
end
...
table.insert(questMod.GroupManager["Crew"].entities,entity.tag)
...
for i=1, #questMod.GroupManager["Crew"].entities do 
local entityTag = questMod.GroupManager["Crew"].entities[i]

if(entityTag == entity.tag) then
table.remove(questMod.GroupManager["Crew"].entities,i)
end
...
questMod.EntityManager[vehiculeobj.tag] = vehiculeobj
