...
AMM = nil
AMMversion = nil
datapackObjectType = { "circuit","dialog","event","faction","fixer","function","housing","help","interact","interfaces","lang","mission","node","npc","phone_dialog","place","poi","radio","shard","sound","texture","scene","housing_template","hud","redmod"}
cacheupdate = false
...
selectedFriend.data = {}
settingsTables = {}
TutorialPopupGameController = nil
pox = 0
poy = 0
poz = 0
sliderPathTarget = 1 
...
inScanner = false
targetObject = nil
incomingCallGameController = nil
...
ModIsLoaded = true
SaveisLoaded = false
questMod.soundpath = "json\\datapack\\"
questMod.autoload = false
tick = 0
ticktimer = 0
cetVer = 1.12
pcWasOpen = false
...
friendIsReady = false
friendMove = false
io.open("net/multi/myfriend.json", "w"):close()
io.open("net/multi/mypos.json", "w"):close()
io.open("net/action.json", "w"):close()
io.open("net/multi.json", "w"):close()
...
local f = assert(io.open("data/db/triggertemplate.json"))
...
triggertemplate = trydecodeJSOn(encdo, f ,"data/db/triggertemplate.json")
...
local f = assert(io.open("data/db/getItems.json"))
...
arrayDBitems = trydecodeJSOn(encdo, f,"data/db/getItems.json")
...
local f2 = assert(io.open("data/db/actiontemplate.json"))
...
actiontemplate = trydecodeJSOn(encdo, f2,"data/db/actiontemplate.json")
